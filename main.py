...
#this class is derived from artist class
#this classs is artist class without birth/death year
#and with title/year_created
class Artwork():
    # TODO: Define constructor with parameters to initialize instance attributes
...
if __name__ == "__main__":
    ...
    #artwork class attributes
    user_title = input()
    user_year_created = int(input())

    #call/create an instance of the artist class
    user_artist = Artist(user_artist_name, user_birth_year, user_death_year)
    #call/create an instance of the artwork class
